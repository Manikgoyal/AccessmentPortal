...
<html>
    <head>
        <meta charset="utf-8">
        <title>Assignment Notifications</title>
            ...
            <div class="centersec clearfix">
                <div class="prof">   
                    ...
                    <section class="centr">
                        ...
                        <form action="AssignmentsServlet" method="post" name="addassignmentnotice" enctype="multipart/form-data">
                            <table class="box-table-a">
                                <caption>Add Assignment Notice</caption>
                                <thead>
                                    <tr>
                                        <th style="width: 90px;">Assignment id</th>
                                        <th style="width: 90px;">Assignment Name</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <input type="text" name="assignmentid" id="assignmentid" class="text1"  required/></td>
                                        <td><input type="text" name="assignmentname" id="assignmentname" class="text1" required/></td>
    ...
    <input id="uploadBtn" type="file" name="upoadFile1" class="upload" />
                                    ...
                                    <tr>
                                        <td>
                                            <a href="#" onclick="JAVASCRIPT:addassignmentnotice.submit()"  class="sbtnSubmit">Add</a>
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                        ...
                        <table class="box-table-a">
                            ...
                            <tbody>
                                <c:forEach items="${alstAssignmentNotice}" var="assignmentnotice">
                                <tr>
                                    ...
                                    <td>${assignmentnotice.file}</td>
                                    <td><a href="CourseContentServlet?filename=${assignmentnotice.file}">Download</a></td>

...
<html>
    <head>
        ...
        <script src="<%=request.getContextPath()%>/pages/subjectidlist.js"></script>
                        ...
                        <form action="CourseContentServlet" method="post" name="addcoursematerial" enctype="multipart/form-data">
                            <table class="box-table-a">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <input type="text" name="lectureid" id="materialid" class="text1"  required/></td>
                                        
                                        <td><select name="semname" id="semname" class="text1" onchange="showUser1(this.value)" >

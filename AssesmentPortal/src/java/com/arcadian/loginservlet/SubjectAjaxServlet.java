 ...
 * @author manik
 */
public class SubjectAjaxServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            CourseContentService contentService=new CourseContentService();
            ArrayList alstSubject=contentService.getSubject(username, classid);
